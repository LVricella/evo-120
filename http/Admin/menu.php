...
<? if ($isAdminFull) { ?>
<li id="p7bullet">
<a href="<?php echo"$directory"?>/Admin/ofTeams.php">
<?php if ($page =="ofTeams") {echo"<font class='menu-active'>";}?>
OF Teams<?php if ($page =="ofTeams") {echo"</font>";}?></a>
</li>
<? } ?>

<? if ($isAdminFull) { ?>
<li id="p7bullet">
<a href="<?php echo"$directory"?>/Admin/ofRoster.php">
<?php if ($page =="ofRoster") {echo"<font class='menu-active'>";}?>
OF Roster<?php if ($page =="ofRoster") {echo"</font>";}?></a>
</li>
<? } ?>

<? if ($isAdminFull) { ?>
<li id="p7bullet">
<a href="<?php echo"$directory"?>/Admin/ofMarket.php">
<?php if ($page =="ofMarket") {echo"<font class='menu-active'>";}?>
OF Market<?php if ($page =="ofMarket") {echo"</font>";}?></a>
</li>
<? } ?>

<? if ($isAdminFull) { ?>
<li id="p7bullet">
<a href="<?php echo"$directory"?>/Admin/ofBuilds.php">
<?php if ($page =="ofBuilds") {echo"<font class='menu-active'>";}?>
OF Builds<?php if ($page =="ofBuilds") {echo"</font>";}?></a>
</li>
<? } ?>
